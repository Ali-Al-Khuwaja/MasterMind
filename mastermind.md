...
Every failing attempt from _the code breaker_ to guess the right secret code will give _the code maker_ a point and if _the code breaker_ fails then _the code maker_ will get 11 points.
...
2\. The code maker will give feedback in an ordered layout.
